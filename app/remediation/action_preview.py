"""Legacy action preview (Phase 10A) for remediation actions.

This module provides read-only previews for registered remediation actions.
It is separate from the Phase 11B CandidatePreviewBuilder which generates
previews from ActionCandidate data.
